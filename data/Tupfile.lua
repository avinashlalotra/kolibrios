...
tup.append_table(img_files, {
 ...
 {"DEVELOP/EXAMPLES/HELLO", VAR_PROGS .. "/develop/examples/hello/trunk/hello"},
 {"DEVELOP/EXAMPLES/EXTFEATURES", VAR_PROGS .. "/develop/examples/extFeatures/extFeatures"},
 {"DEVELOP/EXAMPLES/EXTFEATURES.ASM", SRC_PROGS .. "/develop/examples/extFeatures/extFeatures.asm"},
...
raw_files = {
 ...
 {"KERNEL.MNT", VAR_KERNEL .. "/kernel.mnt.ext_loader"},
 {"DATA/EXT4.IMG", SRC_PROGS .. "/develop/examples/extFeatures/ext4.img"},
